...
if __name__ == '__main__':
    ...
    #train_json_file = './train_selected_data2.json'
    train_json_file = './train_selected_emo_data.json'

    #valid_json_file = './valid_selected_data2.json'
    valid_json_file = 'valid_selected_emo_data.json'

    #aco_path = '/home/data/LJ-speech/normed_cmp/' 
    aco_path = '/home/data/emo_eng/16k_word/normed_cmp/'

    num_down_enc = 4
    num_down_dec = 6

    #file_rate_info = './data_rate_info.npy'
    file_rate_info = 'emo_rate_info.npy'
    ...
    model.collect_params ().load ('parameters_word_1/model_1990', ctx = ctx, allow_missing = True, ignore_extra = True)
    ...
    trainer = gluon.Trainer (para_list, 'adam', {'learning_rate' : 1e-6, 'clip_gradient' : 1.0}) # origin lr 1e-4
